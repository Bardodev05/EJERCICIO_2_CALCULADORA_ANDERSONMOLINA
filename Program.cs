/*• Nombre del estudiante:Anderson Molina Fierro
• Grupo:213023_188
• Programa Académico:Ingenieria en sistemas 
• Problema Seleccionado: <<Escribir número:#2
2. Se quiere implementar una calculadora básica que permita las 
operaciones aritméticas básicas (suma, resta, multiplicación y 
división) utilizando herencia. La superclase debe tener un método 
operación y se debe implementar una clase para cada operación. 
Adicionalmente, las operaciones sumas, restas y multiplicación, 
deben permitir operar con dos o con tres operadores.
>>
